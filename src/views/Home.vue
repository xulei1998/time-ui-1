<template>
<div>
  <div class="topnavAndBanner"> <!--渐变色-->
    <Topnav />    <!--使用封装好的Topnav组件-->
    <div class="banner">
      <h1>Time UI</h1>
  ...
  <div class="features">
    <ul>
      <li>
        <svg><use xlink:href="#icon-Vue"></use></svg>
        <h3>基于 Vue 3</h3>
...
.topnavAndBanner {
  ...
  clip-path: ellipse(80% 60% at 50% 40%);  /* 实现圆弧 */
}
.features {
  margin: 64px auto;
  padding: 0 16px;
...
.banner {
  ...
  >.actions {
    ...
    a {
      margin: 0 8px;
      background: $green; /*github 开始的背景色  */
      color: white;  /* github  开始的颜色 */
